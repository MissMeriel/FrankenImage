...
def reconstruct(vaecp="C:/Users/Meriel/Documents/GitHub/deeplearning-input-rectification/models/weights/checkpoints136x240-origdataset",
                Ximgdir='C:/Users/Meriel/Documents/BeamNG_DeepBillboard_dataset2/training_runs_industrial-racetrackstartinggate_1685samples-4F71PP', 
                Xvalidimgdir='C:/Users/Meriel/Documents/BeamNG_DeepBillboard_dataset2/training_runs_hirochi_raceway-startingline_7755samples-S9SIPZ_YES'):
    model = instantiate_VQVAE(checkpoint_root=vaecp)
    image_dims = (136, 240)
    batch_size=32
    generator = DatasetGenerator([0,1,2], batch_size=10000, dim=(32,32,32), n_channels=1, feature="steering", shuffle=False)
    X = generator.process_img_dir(Ximgdir, size=image_dims)
    ...
    X_valid = generator.process_img_dir(Xvalidimgdir, size=image_dims)
    ...
    ax.set_title('validation data reconstructions')
    plt.axis('off')
    plt.savefig("VQVAE-reconstruct.jpg")
...
def instantiate_VQVAE(checkpoint_root="C:/Users/Meriel/Documents/GitHub/deeplearning-input-rectification/models/weights/checkpoints136x240-origdataset"):
    embedding_dim = 64
    num_embeddings = 512
    commitment_cost = 0.25
...
if __name__ == "__main__":
    # main()
    reconstruct(vaecp="/home/meriel/GitHub/FrankenImage/checkpoints136x240-origdataset",
                Ximgdir="/home/meriel/datasets/training_runs_industrial-racetrackstartinggate_1685samples-4F71PP", 
                Xvalidimgdir="/home/meriel/datasets/training_runs_hirochi_raceway-startingline_7755samples-S9SIPZ_YES")